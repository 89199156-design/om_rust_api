...
STARGAZING_ROOT="${OM_STARGAZING_ROOT:-/opt/1panel/apps/weather_om_webp/data}"
...
GEFS025_STATIC_URL="${OM_GEFS025_STATIC_URL:-https://openmeteo.s3.amazonaws.com/data/ncep_gefs025/static/HSURF.om}"
GEFS025_STATIC_SHA256="${OM_GEFS025_STATIC_SHA256:-09f589bd34aad27f538a5c0cb01c5dbd4114acc27d6b6f24524fd9451ce56f62}"
GEFS025_STATIC_PATH="$MODEL_STATIC_ROOT/static/ncep_gefs025/HSURF.om"
GEFS05_STATIC_URL="${OM_GEFS05_STATIC_URL:-https://openmeteo.s3.amazonaws.com/data/ncep_gefs05/static/HSURF.om}"
GEFS05_STATIC_SHA256="${OM_GEFS05_STATIC_SHA256:-aeb5313b8f402b9098a268b476b480ed065593eb718c358ad01fada0f0f6ddcb}"
GEFS05_STATIC_PATH="$MODEL_STATIC_ROOT/static/ncep_gefs05/HSURF.om"
...
install_verified_static_asset \
  "GEFS025" "$GEFS025_STATIC_URL" "$GEFS025_STATIC_SHA256" "$GEFS025_STATIC_PATH"
install_verified_static_asset \
  "GEFS05" "$GEFS05_STATIC_URL" "$GEFS05_STATIC_SHA256" "$GEFS05_STATIC_PATH"
install_verified_static_asset \
...
OM_STARGAZING_ROOT=$STARGAZING_ROOT
